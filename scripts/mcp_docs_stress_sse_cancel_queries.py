...
Usage:
    uv run scripts/mcp_docs_stress_sse_cancel_queries.py --url http://localhost:8001/mcp --runs 10 --sleep 1.5
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Async MCP Docs stress test client with cancellation (streamable-http)"
    )
    parser.add_argument(
        "--url",
        default="prod",
