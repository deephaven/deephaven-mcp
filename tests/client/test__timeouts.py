...
def test_enterprise_client_default_values():
    ...
    assert cfg.controller_resubscribe_backoff_initial_seconds == 30.0
    assert cfg.controller_resubscribe_backoff_max_seconds == 300.0
...
def test_enterprise_client_model_fields_set():
    assert set(EnterpriseClientTimeouts.model_fields) == {
        ...
        "controller_resubscribe_backoff_initial_seconds",
    ...
    cfg = EnterpriseClientTimeouts.model_validate(
        {
            ...
            "controller_resubscribe_backoff_initial_seconds": 2.5,
            "controller_resubscribe_backoff_max_seconds": 40.0,
