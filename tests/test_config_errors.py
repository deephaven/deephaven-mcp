...
def test_community_session_configuration_error_is_subclass():
    assert issubclass(errors.CommunitySessionConfigurationError, errors.McpConfigurationError)
...
def test_enterprise_system_configuration_error_is_subclass():
    assert issubclass(errors.EnterpriseSystemConfigurationError, errors.McpConfigurationError)
