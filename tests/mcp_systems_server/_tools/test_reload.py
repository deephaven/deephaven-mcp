...
from deephaven_mcp.mcp_systems_server._tools.reload import mcp_reload
...
def test_register_tools_registers_mcp_reload():
    """register_tools() registers mcp_reload with the given FastMCP server."""
    from mcp.server.fastmcp import FastMCP

    from deephaven_mcp.mcp_systems_server._tools.reload import register_tools

    server = FastMCP("test-reload-server")
