---
name: ref-markdown-documentation-standards
...
- American English spelling throughout — apply `ref-python-coding-practices` rule 8 (statement, enforcement, and ignore convention). Markdown-specific delta: in prose, the ignore comment takes the HTML-comment form `<!-- codespell:ignore word1,word2 -->` on the same line, which renders invisibly.
