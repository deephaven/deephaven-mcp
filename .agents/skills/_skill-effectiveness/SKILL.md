...
- **Acceptable / unacceptable pairs:**
  - ✅ "Add a new command to the dhcli CLI — wraps the click + Pattern B + structured-error + agents-manifest conventions; prevents the most common bugs." (Names the artifact, names the verb, names the failure mode it prevents.)
