...
14. **Spelling**: apply `_python-coding-practices` rule 8 to the whole file (identifiers and string literals included, not just docstrings); run `uv run codespell <file>` and flag what it reports.
