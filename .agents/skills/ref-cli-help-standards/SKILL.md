...
- `uv run pytest tests/cli/test_help_contract.py tests/cli/test__help.py tests/cli/test__manifest.py tests/cli/_commands/test_agents.py` is green — the content-preservation test in `tests/cli/test__manifest.py` asserts every `HelpSpec` fact surfaces in the node.
