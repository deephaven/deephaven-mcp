...
3. **Constant Placement**:
   ...
   - Operator-tunable values (timeouts, defaults, thresholds) are **not** module constants — see the `ref-configuration-conventions` skill for where they live and how to read them.
