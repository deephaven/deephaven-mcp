...
| `private_key` | `key_text` | [Deephaven private key](https://deephaven.io/enterprise/docs/sys-admin/admin-glossary/#private-key-login-keypair-files) contents (use `${file:/path/to/priv-<keyname>.base64.txt}` to load from disk). |
